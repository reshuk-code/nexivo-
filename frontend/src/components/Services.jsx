...
export default function Services() {
  ...
  return (
    <>
      <Helmet>
        <title>Our Services - NEXIVO IT Solutions</title>
        <meta name="description" content="Explore our comprehensive IT services including web development, mobile apps, AI/ML solutions, UI/UX design, and digital transformation services." />
        <meta name="keywords" content="web development, mobile apps, AI solutions, UI/UX design, digital transformation, IT services, software development" />
        <link rel="canonical" href="https://reshuksapkota.com.np/services" />
      </Helmet>
